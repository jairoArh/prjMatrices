...
public class HandlingMatriz {
     ...
     * @return la suma de los elementos de la fila especificada, si la fila está fuera de rango, retorna -1
     */
     ...
     * @return la suma de los elementos de la fila especificada, si la columna está fuera de rango, retorna -1
     */
     ...
     * @return la suma de los elementos de la diagonal secundaria. Si no se puede retorna -1
     */
     ...
     * @param mat especifica la matriz con la cual se va a multiplicar la matriz de la clase
     * @return una matriz con el resultado de la multiplicación de las dos matrices. Si no se puede, retorna null
     */
     ...
     * @param mat especifica la matriz con la que se va a sumar la matriz de la clase,
     * @return un arreglo de dos dimensiones con la suma de la matriz, si no son del mismo orden retorna null
     */
     ...
     * @return un arreglo de dos dimensiones con la inversa de la matriz, si no se puede retorna null
     */
